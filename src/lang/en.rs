...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("ID/Relay Server", "Alternative ID/Relay server"),
        ...
        ("empty_lan_tip", "No peers detected on this LAN."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "This feature is not yet supported."),
