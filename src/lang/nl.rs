...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("Status", "Status"),
        ("Your Desktop", "Uw Apparaat"),
        ("desk_tip", "Uw apparaat is toegankelijk met dit ID en wachtwoord."),
        ("Password", "Wachtwoord"),
        ("Ready", "Klaar"),
        ("Established", "Opgezet"),
        ...
        ("Control Remote Desktop", "Beheer Extern Apparaat"),
        ...
        ("ID/Relay Server", "Alternatieve ID-/Relayserver"),
        ...
        ("Custom", "Aangepast"),
        ("Show remote cursor", "Toon cursor van extern apparaat"),
        ...
        ("Remote desktop is offline", "Extern apparaat is offline"),
        ...
        ("install_tip", "Door UAC-beperkingen lukt het niet altijd om uw apparaat op afstand te bedienen. Installeer RustDesk op het systeem om dit probleem te voorkomen."),
        ...
        ("config_screen", "Om toegang te krijgen tot het externe apparaat, moet u RustDesk toestemming voor \"schermregistratie\" geven."),
        ...
        ("config_input", "Om het externe apparaat vanaf het toetsenbord te kunnen bedienen, moet u RustDesk de rechten \"Invoer vastleggen\" geven."),
        ...
        ("Please confirm if you want to share your desktop?", "Bevestig dat u uw apparaat wilt delen?"),
        ("Display", "Weergave"),
        ...
        ("empty_recent_tip", "Geen recente sessies."),
        ("empty_favorite_tip", "Nog geen favoriete apparaten."),
        ("empty_lan_tip", "Nog geen apparaten ontdekt op dit LAN."),
        ("empty_address_book_tip", "Nog geen apparaten in uw adresboek."),
        ...
        ("os_account_desk_tip", "Dit account wordt gebruikt om toegang te krijgen tot het externe besturingssysteem en de apparaatsessie in onbeheerde modus te activeren."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Deze functionaliteit is nog niet ondersteund."),
